...
const style: string[] = ["normal", "italic"];
...
const align: string[] = ["initial", "inherit", "unset", "left", "right", "center", "start", "end", "justify"];

export default function Text({ count, title, attrs }: TextProps): JSX.Element {
	if (!attrs) {
		attrs = {};
	}
	return (
			...
			<section className={`new-line padding-none`}>
				...
				<div className="seldiv-text">
					<ul className="ul-input">
						<input className="input-text" type="text" placeholder="Ввод" value={attrs["font-family"]} />
						<input className="input-text" type="text" placeholder="Ввод" value={attrs["font-weight"]} />
						<input className="input-text" type="text" placeholder="Ввод" value={attrs["font-size"]} />
						<input className="input-text" type="text" placeholder="Ввод" value={attrs["font-height"]} />
					</ul>
					<ul>
